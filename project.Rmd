...
```{r, echo = FALSE, fig.height = 3.8, fig.width = 10, fig.align='center'}
#income
...
```{r, fig.height = 3.5, fig.width = 10, warning = FALSE, fig.align='center'}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, fig.align='center', strip.white = FALSE}
